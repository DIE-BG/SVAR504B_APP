...
if do_graphs == true
    ...
    % Plots de Simulación
    simPlots(MODEL,...
        'StartDate',{MODEL.DATES.hist_start+3, MODEL.DATES.hist_end - 20},...
        ...
        'LegendsNames',{'Historia', MODEL.leg_ant, MODEL.leg_act},...
        'TabRange', tab_range...
        );
    % Post Procesamiento
    ...
    tcr_subplot(MODEL,...
        ...
        'tab_range', tab_range,...
        'LegendsNames',{MODEL.leg_ant, MODEL.leg_act, 'Historia'})
    ...
    contributions(MODEL,...
                  'SavePath',fullfile('plots', MODEL.CORR_DATE,...
                  MODEL.CORR_VER, 'contributions'),...
                  'Esc_add', {'v0', MODEL_ANT});
              
    contributions(MODEL,...
                  'SavePath',fullfile('plots',...
                  MODEL.CORR_DATE, MODEL.CORR_VER, 'diff contributions'),...
                  'Esc_add', {'v0', MODEL_ANT},...
                  'diff', true);

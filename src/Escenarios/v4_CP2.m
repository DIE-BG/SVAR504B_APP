...
MODEL.Esc.v4.dbi.i(MODEL.DATES.pred_start) = MODEL.Esc.v4.dbi.i(MODEL.DATES.hist_end) + d_i;  
MODEL.Esc.v4.dbi.d4_ln_bm(MODEL.DATES.pred_start) = MODEL.Esc.v4.dbi.d4_ln_bm(MODEL.DATES.hist_end) + d_bm;  
...
MODEL.Esc.v4.planSim = endogenize(MODEL.Esc.v4.planSim,{'s_i'},MODEL.DATES.pred_start); 
MODEL.Esc.v4.planSim = endogenize(MODEL.Esc.v4.planSim,{'s_d4_ln_bm'},MODEL.DATES.pred_start); 
% Variable a exogenizar (Anclaje)
MODEL.Esc.v4.planSim = exogenize(MODEL.Esc.v4.planSim,{'i'},MODEL.DATES.pred_start);
MODEL.Esc.v4.planSim = exogenize(MODEL.Esc.v4.planSim,{'d4_ln_bm'},MODEL.DATES.pred_start);

...
params.LegendsNames = {leg_act, leg_ant};
...
for var = 1: length(list)
    ...
    if startsWith(list{var}, 'd4_') || startsWith(list{var}, 'dla_') && params.PlotSSLine
        hline(...
            real(SS.(list{var})), ...
            'LineWidth', 1.5, ...
            'LineStyle', ':' ...
    ...
    if startsWith(list{var}, 'd4_') || startsWith(list{var}, 'dla_') && params.PlotAnnotations
...
% AGREGAR CONDICIONALES PARA NOMBRES O CARPETA DISTINTA?

if rng == 2
   save_name = sprintf("%s_%s_short.png", num, list{var});
else
   save_name = sprintf("%s_%s.png", num, list{var}); 
end

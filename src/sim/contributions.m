...
col = [[0.627 0.208 0.247]; col];
    ...
    for rng = params.StartDate
        ...
        bar(rng{1}:params.EndDatePlot{1},...
            [(temp_F.k5),...
            (MODEL.F.g_1_51*temp_F_pred.d4_ln_y_star.shift(-1)    - MODEL.F.g_0_51*temp_F_pred.d4_ln_y_star),...
            (MODEL.F.g_1_52*temp_F_pred.d4_ln_ipei.shift(-1)      - MODEL.F.g_0_52*temp_F_pred.d4_ln_ipei),......
            (MODEL.F.g_1_53*temp_F_pred.i_star.shift(-1)          - MODEL.F.g_0_53*temp_F_pred.i_star),...,...
            (MODEL.F.g_1_54*temp_F_pred.d4_ln_cpi_nosub.shift(-1) - MODEL.F.g_0_54*temp_F_pred.d4_ln_cpi_nosub),......
            (MODEL.F.g_1_55*temp_F_pred.d4_ln_y.shift(-1)),...
            (MODEL.F.g_1_56*temp_F_pred.d4_ln_cpi_sub.shift(-1)),...
            (MODEL.F.g_1_57*temp_F_pred.d4_ln_s.shift(-1)),...
            (MODEL.F.g_1_58*temp_F_pred.d4_ln_bm.shift(-1))...
            (MODEL.F.g_1_59*temp_F_pred.i.shift(-1)),...
            (temp_F_pred.s_d4_ln_y)],...
            'stacked');
        
        hold on

        % Lineas
        plot(rng{1}:params.EndDatePlot{1}, temp_F_pred.d4_ln_y,'w','LineWidth',5);
        plot(rng{1}:params.EndDatePlot{1}, temp_F_pred.d4_ln_y,'k.-','LineWidth',2, 'MarkerSize', 20);
        ...
        if rng{1} == params.StartDate{1}
                ...
                sprintf("%s_%s.png", 'd4_ln_y', MODEL.leg_act)), ...
                'AutoSave', true);

        elseif rng{1} == params.StartDate{2}
                SimTools.scripts.pausaGuarda(...
                fullfile(params.SavePath, 'short',...
                sprintf("%s_%s_short.png", 'd4_ln_y', MODEL.leg_act)), ...
                'AutoSave', true);
        ...
        bar(rng{1}:params.EndDatePlot{1},...
           [(temp_F.k5),...
            ...
            (MODEL.F.g_1_56*full_data_add.F_pred.d4_ln_cpi_sub.shift(-1)),...
            (MODEL.F.g_1_57*full_data_add.F_pred.d4_ln_s.shift(-1)),...
            (MODEL.F.g_1_58*full_data_add.F_pred.d4_ln_bm.shift(-1))...
            (MODEL.F.g_1_59*full_data_add.F_pred.i.shift(-1)),...
...
%% Inflación subyacente         
    for rng = params.StartDate
        ...
        bar(rng{1}:params.EndDatePlot{1},...
            [temp_F.k6,...1
             MODEL.F.g_1_61*temp_F_pred.d4_ln_y_star.shift(-1) - MODEL.F.g_0_61*temp_F_pred.d4_ln_y_star,...2
             MODEL.F.g_1_62*temp_F_pred.d4_ln_ipei.shift(-1)   - MODEL.F.g_0_62*temp_F_pred.d4_ln_ipei,...3
             MODEL.F.g_1_63*temp_F_pred.i_star.shift(-1)       - MODEL.F.g_0_63*temp_F_pred.i_star,...4
             MODEL.F.g_1_64*temp_F_pred.d4_ln_cpi_nosub.shift(-1) - MODEL.F.g_0_64*temp_F_pred.d4_ln_cpi_nosub,...5
             MODEL.F.g_1_65*temp_F_pred.d4_ln_y.shift(-1)      - MODEL.F.g_0_65*temp_F_pred.d4_ln_y,...6
             MODEL.F.g_1_66*temp_F_pred.d4_ln_cpi_sub.shift(-1),...7
             MODEL.F.g_1_67*temp_F_pred.d4_ln_s.shift(-1),... 8
             MODEL.F.g_1_68*temp_F_pred.d4_ln_bm.shift(-1),... 9
             MODEL.F.g_1_69*temp_F_pred.i.shift(-1),... 10
             temp_F_pred.s_d4_ln_cpi_sub],...11
            'stacked');
        
        hold on

        % Lineas
        plot(rng{1}:params.EndDatePlot{1}, temp_F_pred.d4_ln_cpi_sub,'w','LineWidth',5);
        plot(rng{1}:params.EndDatePlot{1}, temp_F_pred.d4_ln_cpi_sub,'k.-','LineWidth',2, 'MarkerSize', 20);
        ...
        if rng{1} == params.StartDate{1}
                SimTools.scripts.pausaGuarda(...
                fullfile(params.SavePath, 'long',...
                sprintf("%s_%s.png", 'd4_ln_cpi_sub', MODEL.leg_act)), ...
                'AutoSave', true);

        elseif rng{1} == params.StartDate{2}
                SimTools.scripts.pausaGuarda(...
                fullfile(params.SavePath, 'short',...
                sprintf("%s_%s_short.png", 'd4_ln_cpi_sub', MODEL.leg_act)), ...
                'AutoSave', true);
        end
        ...
        bar(rng{1}:params.EndDatePlot{1},...
            [temp_F.k6,...1
             ...
             (MODEL.F.g_1_67*full_data_add.F_pred.d4_ln_s.shift(-1)),...8
             (MODEL.F.g_1_68*full_data_add.F_pred.d4_ln_bm.shift(-1)),... 9
             (MODEL.F.g_1_69*full_data_add.F_pred.i.shift(-1)),... 10
...
%% Base Monetaria
    ...
    for rng = params.StartDate
        ...
        bar(rng{1}:params.EndDatePlot{1},...
            [temp_F.k8,...1
             (MODEL.F.g_1_81*temp_F_pred.d4_ln_y_star.shift(-1) - MODEL.F.g_0_81*temp_F_pred.d4_ln_y_star),...1
             (MODEL.F.g_1_82*temp_F_pred.d4_ln_ipei.shift(-1)   - MODEL.F.g_0_82*temp_F_pred.d4_ln_ipei),...2
             (MODEL.F.g_1_83*temp_F_pred.i_star.shift(-1)       - MODEL.F.g_0_83*temp_F_pred.i_star),...4
             (MODEL.F.g_1_84*temp_F_pred.d4_ln_cpi_nosub.shift(-1) - MODEL.F.g_0_84*temp_F_pred.d4_ln_cpi_nosub),...5
             (MODEL.F.g_1_85*temp_F_pred.d4_ln_y.shift(-1)         - MODEL.F.g_0_85*temp_F_pred.d4_ln_y),...6
             (MODEL.F.g_1_86*temp_F_pred.d4_ln_cpi_sub.shift(-1)   - MODEL.F.g_0_86*temp_F_pred.d4_ln_cpi_sub),...7
             (MODEL.F.g_1_87*temp_F_pred.d4_ln_s.shift(-1)         - MODEL.F.g_0_87*temp_F_pred.d4_ln_s ),...8
             (MODEL.F.g_1_88*temp_F_pred.d4_ln_bm.shift(-1)),... 9
             (MODEL.F.g_1_89*temp_F_pred.i.shift(-1)),...10
              temp_F_pred.s_d4_ln_bm],...11
            'stacked');
        
        hold on

        % Lineas
        plot(rng{1}:params.EndDatePlot{1}, temp_F_pred.d4_ln_bm,'w','LineWidth',5);
        plot(rng{1}:params.EndDatePlot{1}, temp_F_pred.d4_ln_bm,'k.-','LineWidth',2, 'MarkerSize', 20);
        ...
        if rng{1} == params.StartDate{1}
                SimTools.scripts.pausaGuarda(...
                fullfile(params.SavePath, 'long',...
                sprintf("%s_%s.png", 'd4_ln_bm', MODEL.leg_act)), ...
                'AutoSave', true);

        elseif rng{1} == params.StartDate{2}
                SimTools.scripts.pausaGuarda(...
                fullfile(params.SavePath, 'short',...
                sprintf("%s_%s_short.png", 'd4_ln_bm', MODEL.leg_act)), ...
                'AutoSave', true);
        end
        ...
        bar(rng{1}:params.EndDatePlot{1},...
            [temp_F.k8,...1
             (MODEL.F.g_1_81*full_data_add.F_pred.d4_ln_y_star.shift(-1) - MODEL.F.g_0_81*full_data_add.F_pred.d4_ln_y_star),...2
             (MODEL.F.g_1_82*full_data_add.F_pred.d4_ln_ipei.shift(-1)   - MODEL.F.g_0_82*full_data_add.F_pred.d4_ln_ipei),...3
             (MODEL.F.g_1_83*full_data_add.F_pred.i_star.shift(-1)       - MODEL.F.g_0_83*full_data_add.F_pred.i_star),...4
             (MODEL.F.g_1_84*full_data_add.F_pred.d4_ln_cpi_nosub.shift(-1) - MODEL.F.g_0_84*full_data_add.F_pred.d4_ln_cpi_nosub),...5
             (MODEL.F.g_1_85*full_data_add.F_pred.d4_ln_y.shift(-1)         - MODEL.F.g_0_85*full_data_add.F_pred.d4_ln_y),...6
             (MODEL.F.g_1_86*full_data_add.F_pred.d4_ln_cpi_sub.shift(-1)   - MODEL.F.g_0_86*full_data_add.F_pred.d4_ln_cpi_sub),...7
             (MODEL.F.g_1_87*full_data_add.F_pred.d4_ln_s.shift(-1)         - MODEL.F.g_0_87*full_data_add.F_pred.d4_ln_s ),...8
             (MODEL.F.g_1_88*full_data_add.F_pred.d4_ln_bm.shift(-1)),... 9
             (MODEL.F.g_1_89*full_data_add.F_pred.i.shift(-1)),...10
...
%% Tasa de interés
    ...
    for rng = params.StartDate
        ...
        bar(rng{1}:params.EndDatePlot{1},...
            [temp_F.k9,...1
             (MODEL.F.g_1_91*temp_F_pred.d4_ln_y_star.shift(-1)    - MODEL.F.g_0_91*temp_F_pred.d4_ln_y_star),...2
             (MODEL.F.g_1_92*temp_F_pred.d4_ln_ipei.shift(-1)      - MODEL.F.g_0_92*temp_F_pred.d4_ln_ipei ),...3
             (MODEL.F.g_1_93*temp_F_pred.i_star.shift(-1)          - MODEL.F.g_0_93*temp_F_pred.i_star),...4
             (MODEL.F.g_1_94*temp_F_pred.d4_ln_cpi_nosub.shift(-1) - MODEL.F.g_0_94*temp_F_pred.d4_ln_cpi_nosub),...5
             (MODEL.F.g_1_95*temp_F_pred.d4_ln_y.shift(-1)         - MODEL.F.g_0_95*temp_F_pred.d4_ln_y),... 6
             (MODEL.F.g_1_96*temp_F_pred.d4_ln_cpi_sub.shift(-1)   - MODEL.F.g_0_96*temp_F_pred.d4_ln_cpi_sub),...7
             (MODEL.F.g_1_97*temp_F_pred.d4_ln_s.shift(-1)         - MODEL.F.g_0_97*temp_F_pred.d4_ln_s),...8
             (MODEL.F.g_1_98*temp_F_pred.d4_ln_bm.shift(-1)        - MODEL.F.g_0_98*temp_F_pred.d4_ln_bm ),...9
        ...
        bar(rng{1}:params.EndDatePlot{1},...
            [temp_F.k9,...1
             (MODEL.F.g_1_91*full_data_add.F_pred.d4_ln_y_star.shift(-1)    - MODEL.F.g_0_91*full_data_add.F_pred.d4_ln_y_star),...2
             (MODEL.F.g_1_92*full_data_add.F_pred.d4_ln_ipei.shift(-1)      - MODEL.F.g_0_92*full_data_add.F_pred.d4_ln_ipei ),...3
             (MODEL.F.g_1_93*full_data_add.F_pred.i_star.shift(-1)          - MODEL.F.g_0_93*full_data_add.F_pred.i_star),...4
             (MODEL.F.g_1_94*full_data_add.F_pred.d4_ln_cpi_nosub.shift(-1) - MODEL.F.g_0_94*full_data_add.F_pred.d4_ln_cpi_nosub),...5
             (MODEL.F.g_1_95*full_data_add.F_pred.d4_ln_y.shift(-1)         - MODEL.F.g_0_95*full_data_add.F_pred.d4_ln_y),... 6
             (MODEL.F.g_1_96*full_data_add.F_pred.d4_ln_cpi_sub.shift(-1)   - MODEL.F.g_0_96*full_data_add.F_pred.d4_ln_cpi_sub),...7
             (MODEL.F.g_1_97*full_data_add.F_pred.d4_ln_s.shift(-1)         - MODEL.F.g_0_97*full_data_add.F_pred.d4_ln_s),...8
             (MODEL.F.g_1_98*full_data_add.F_pred.d4_ln_bm.shift(-1)        - MODEL.F.g_0_98*full_data_add.F_pred.d4_ln_bm ),...9
             (MODEL.F.g_1_99*full_data_add.F_pred.i.shift(-1)),...10

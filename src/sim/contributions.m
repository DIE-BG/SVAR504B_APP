...
col = [[0.627 0.208 0.247]; col];
    ...
    for rng = params.StartDate
        ...
        if rng{1} == params.StartDate{1}
                ...
                sprintf("%s_%s.png", 'dla_y', MODEL.CORR_DATE)), ...
                'AutoSave', true);

        elseif rng{1} == params.StartDate{2}
                SimTools.scripts.pausaGuarda(...
                fullfile(params.SavePath, 'short',...
                sprintf("%s_%s_short.png", 'dla_y', MODEL.CORR_DATE)), ...
                'AutoSave', true);
...
%% Inflación subyacente         
    for rng = params.StartDate
        ...
        if rng{1} == params.StartDate{1}
                SimTools.scripts.pausaGuarda(...
                fullfile(params.SavePath, 'long',...
                sprintf("%s_%s.png", 'dla_cpi_sub', MODEL.CORR_DATE)), ...
                'AutoSave', true);

        elseif rng{1} == params.StartDate{2}
                SimTools.scripts.pausaGuarda(...
                fullfile(params.SavePath, 'short',...
                sprintf("%s_%s_short.png", 'dla_cpi_sub', MODEL.CORR_DATE)), ...
                'AutoSave', true);
        end
        ...
        bar(rng{1}:params.EndDatePlot{1},...
            [temp_F.k6,...1
             (full_data_add.F.g_1_61*full_data_add.F_pred.dla_y_star.shift(-1) - full_data_add.F.g_0_61*full_data_add.F_pred.dla_y_star),...2
             (full_data_add.F.g_1_62*full_data_add.F_pred.dla_ipei.shift(-1)   - full_data_add.F.g_0_62*full_data_add.F_pred.dla_ipei),...3
             (full_data_add.F.g_1_63*full_data_add.F_pred.i_star.shift(-1)       - full_data_add.F.g_0_63*full_data_add.F_pred.i_star),...4
             (full_data_add.F.g_1_64*full_data_add.F_pred.dla_cpi_nosub.shift(-1) - full_data_add.F.g_0_64*full_data_add.F_pred.dla_cpi_nosub),...5
             (full_data_add.F.g_1_65*full_data_add.F_pred.dla_y.shift(-1)      -full_data_add.F.g_0_65*full_data_add.F_pred.dla_y),...6
             (full_data_add.F.g_1_66*full_data_add.F_pred.dla_cpi_sub.shift(-1)),...7
             (full_data_add.F.g_1_67*full_data_add.F_pred.dla_s.shift(-1)),...8
             (full_data_add.F.g_1_68*full_data_add.F_pred.dla_bm.shift(-1)),... 9
...
%% Base Monetaria
    ...
    for rng = params.StartDate
        ...
        if rng{1} == params.StartDate{1}
                SimTools.scripts.pausaGuarda(...
                fullfile(params.SavePath, 'long',...
                sprintf("%s_%s.png", 'dla_bm', MODEL.CORR_DATE)), ...
                'AutoSave', true);

        elseif rng{1} == params.StartDate{2}
                SimTools.scripts.pausaGuarda(...
                fullfile(params.SavePath, 'short',...
                sprintf("%s_%s_short.png", 'dla_bm', MODEL.CORR_DATE)), ...
                'AutoSave', true);
        end
...
%% Tasa de interés
    ...
    for rng = params.StartDate
        ...
        if rng{1} == params.StartDate{1}
                SimTools.scripts.pausaGuarda(...
                fullfile(params.SavePath, 'long',...
                sprintf("%s_%s.png", 'i_SVAR50', full_data_add.CORR_DATE)), ...
                'AutoSave', true);

        elseif rng{1} == params.StartDate{2}
                SimTools.scripts.pausaGuarda(...
                fullfile(params.SavePath, 'short',...
                sprintf("%s_%s_short.png", 'i_SVAR50', full_data_add.CORR_DATE)), ...
                'AutoSave', true);

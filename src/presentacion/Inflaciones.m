...
if strcmp(folder_name{i}, 'v0')
        ...
        exportToPPTX('addpicture',...
                    fullfile('plots',MODEL.CORR_DATE, folder_name{i},... 
                             'contributions','long', sprintf('d4_ln_cpi_sub_%s.png', MODEL.leg_ant)),... 
                    'Position',[0/2.54 0/2.54 16.93/2.54 17.57/2.54]);

        exportToPPTX('addpicture',...
                    fullfile('plots',MODEL.CORR_DATE, folder_name{i},... 
                             'contributions','long', sprintf('d4_ln_cpi_sub_%s.png', MODEL.leg_act)),... 
        ...
        exportToPPTX('addpicture',...
                    fullfile('plots',MODEL.CORR_DATE, folder_name{i},... 
                             'contributions','short', sprintf('d4_ln_cpi_sub_%s_short.png', MODEL.leg_ant)),...
                    'Position',[0/2.54 0/2.54 16.93/2.54 17.57/2.54]);

        exportToPPTX('addpicture',...
                    fullfile('plots',MODEL.CORR_DATE, folder_name{i},... 
                             'contributions','short', sprintf('d4_ln_cpi_sub_%s_short.png', MODEL.leg_act)),... 
                    'Position',[16.93/2.54 0/2.54 16.93/2.54 17.57/2.54]);
...
if strcmp(folder_name{i}, 'v0')  
        ...
        exportToPPTX('addpicture',...
                    fullfile('plots',MODEL.CORR_DATE, folder_name{i},... 
                             'diff contributions','short',sprintf('d4_ln_cpi_sub_%s_short.png', MODEL.leg_ant)),...
                    'Position',[0/2.54 0/2.54 16.93/2.54 17.57/2.54]);

        exportToPPTX('addpicture',...
                    fullfile('plots',MODEL.CORR_DATE, folder_name{i},... 
                             'diff contributions','short', sprintf('d4_ln_cpi_sub_%s_short.png', MODEL.leg_act)),... 
                    'Position',[16.93/2.54 0/2.54 16.93/2.54 17.57/2.54]);
...
% Long
        ...
        exportToPPTX('addpicture',...
                    fullfile('plots',corr_date,folder_name{i},... 
                             'shock_dec','long', 'SVAR504B','d4_ln_cpi_sub_shd_dsc.png'),... 
        ...
        exportToPPTX('addpicture',...
                    fullfile('plots',corr_date,folder_name{i},... 
                             'shock_dec','short', 'SVAR504B','d4_ln_cpi_sub_shd_dsc.png'),... 
                    'Position',[0 2.51/2.54 16.93/2.54 14.98/2.54]);
...
if strcmp(folder_name{i}, 'v0')
        ...
        exportToPPTX('addpicture',...
                    fullfile('plots',corr_date,folder_name{i},... 
                             'shock_dec','diff', 'SVAR504B','12_d4_ln_cpi_sub_diff_shd_dsc.png'),... 
                    'Position',[0 2.51/2.54 16.93/2.54 14.98/2.54]);

        exportToPPTX('addpicture',...
                    fullfile('plots',MODEL.CORR_DATE,folder_name{i},... 
                             'shock_dec','diff','12_d4_ln_cpi_sub_diff_shd_dsc.png'),...
                    'Position',[16.93/2.54 2.51/2.54 16.93/2.54 14.98/2.54]);  
        exportToPPTX('addtext',sprintf('Corrimiento %s', MODEL.leg_act),...
                     'Position',[17.04/2.54, 1.2/2.54, 16.93/2.54, 1.05/2.54],...
                     'HorizontalAlignment', 'center','fontsize',18);
...
if strcmp(folder_name{i}, 'v0')
        ...
        exportToPPTX('addpicture',...
                    fullfile('plots',corr_date,folder_name{i},... 
                             'shock_dec','long','SVAR504B','d4_ln_cpi_nosub_shd_dsc.png'),... 
                    'Position',[0 2.51/2.54 16.93/2.54 14.98/2.54]);
        ...
        exportToPPTX('addpicture',...
                    fullfile('plots',corr_date,folder_name{i},... 
                             'shock_dec','short','SVAR504B','d4_ln_cpi_nosub_shd_dsc.png'),... 
                    'Position',[0 2.51/2.54 16.93/2.54 14.98/2.54]);
...
if strcmp(folder_name{i}, 'v0')
        ...
        exportToPPTX('addpicture',...
                    fullfile('plots',corr_date,folder_name{i},... 
                             'shock_dec','diff','SVAR504B','13_d4_ln_cpi_nosub_diff_shd_dsc.png'),... 
                    'Position',[0 2.51/2.54 16.93/2.54 14.98/2.54]);

        exportToPPTX('addpicture',...
                    fullfile('plots',MODEL.CORR_DATE,folder_name{i},... 
                             'shock_dec','diff','13_d4_ln_cpi_nosub_diff_shd_dsc.png'),...
                    'Position',[16.93/2.54 2.51/2.54 16.93/2.54 14.98/2.54]);  
        exportToPPTX('addtext',sprintf('Corrimiento %s', MODEL.leg_act),...
                     'Position',[17.04/2.54, 1.2/2.54, 16.93/2.54, 1.05/2.54],...
                     'HorizontalAlignment', 'center','fontsize',18);
...
if strcmp(folder_name{i}, 'v0')
        ...
        exportToPPTX('addpicture',...
                    fullfile('plots',corr_date,folder_name{i},... 
                             'shock_dec','long','SVAR504B','d4_ln_cpi_shd_dsc.png'),... 
                    'Position',[0 2.51/2.54 16.93/2.54 14.98/2.54]);
        ...
        exportToPPTX('addpicture',...
                    fullfile('plots',corr_date,folder_name{i},... 
                             'shock_dec','short','SVAR504B','d4_ln_cpi_shd_dsc.png'),... 
                    'Position',[0 2.51/2.54 16.93/2.54 14.98/2.54]);
...
if strcmp(folder_name{i}, 'v0')
        ...
        exportToPPTX('addpicture',...
                    fullfile('plots',corr_date,folder_name{i},... 
                             'shock_dec','diff','SVAR504B','07_d4_ln_cpi_diff_shd_dsc.png'),... 
                    'Position',[0 2.51/2.54 16.93/2.54 14.98/2.54]);
...
if strcmp(folder_name{i}, 'v0')
        ...
        exportToPPTX('addpicture',...
                    fullfile('plots',MODEL.CORR_DATE,folder_name{i},... 
                             'prediction_compared',sprintf('Comp_Inf_%s.png', MODEL.leg_ant)),...
                    'Position',[0 0 16.93/2.54 17.57/2.54]);
        exportToPPTX('addpicture',...
                    fullfile('plots',MODEL.CORR_DATE,folder_name{i},... 
                             'prediction_compared',sprintf('Comp_Inf_%s.png', MODEL.leg_act)),...
                     'Position',[16.93/2.54 0 16.93/2.54 17.57/2.54]);
        ...
        exportToPPTX('addpicture',...
                    fullfile('plots',MODEL.CORR_DATE,folder_name{i},... 
                             'prediction_compared',sprintf('Comp_Inf_short_%s.png', MODEL.leg_ant)),...
                    'Position',[0 0 16.93/2.54 17.57/2.54]);
        exportToPPTX('addpicture',...
                    fullfile('plots',MODEL.CORR_DATE,folder_name{i},... 
                             'prediction_compared',sprintf('Comp_Inf_short_%s.png', MODEL.leg_act)),...
                     'Position',[16.93/2.54 0 16.93/2.54 17.57/2.54]);

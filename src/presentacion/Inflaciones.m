...
if strcmp(folder_name{i}, 'v0')
        ...
        exportToPPTX('addpicture',...
                    fullfile('plots',MODEL.CORR_DATE, folder_name{i},... 
                             'contributions','long', sprintf('dla_cpi_sub_%s.png', MODEL.leg_act)),... 
        ...
        exportToPPTX('addpicture',...
                    fullfile('plots',MODEL.CORR_DATE, folder_name{i},... 
                             'contributions','short', sprintf('dla_cpi_sub_%s_short.png', MODEL.leg_act)),... 
                    'Position',[16.93/2.54 0/2.54 16.93/2.54 17.57/2.54]);
...
if strcmp(folder_name{i}, 'v0')  
        ...
        exportToPPTX('addpicture',...
                    fullfile('plots',MODEL.CORR_DATE, folder_name{i},... 
                             'diff contributions','short', sprintf('dla_cpi_sub_%s_short.png', MODEL.leg_act)),... 
                    'Position',[16.93/2.54 0/2.54 16.93/2.54 17.57/2.54]);

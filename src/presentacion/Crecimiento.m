...
if strcmp(folder_name{i}, 'v0')
        ...
        exportToPPTX('addpicture',...
                    fullfile('plots',MODEL.CORR_DATE, folder_name{i},... 
                             'contributions','long', sprintf('d4_ln_y_%s.png', MODEL.CORR_DATE_ANT)),... 
        ...
        exportToPPTX('addpicture',...
                    fullfile('plots',MODEL.CORR_DATE, folder_name{i},... 
                             'contributions','short', sprintf('d4_ln_y_%s_short.png', MODEL.CORR_DATE_ANT)),...
                    'Position',[0/2.54 0/2.54 16.93/2.54 17.57/2.54]);
...
if strcmp(folder_name{i}, 'v0')  
        ...
        exportToPPTX('addpicture',...
                    fullfile('plots',MODEL.CORR_DATE, folder_name{i},... 
                             'diff contributions','short',sprintf('d4_ln_y_%s_short.png', MODEL.CORR_DATE_ANT)),...
                    'Position',[0/2.54 0/2.54 16.93/2.54 17.57/2.54]);

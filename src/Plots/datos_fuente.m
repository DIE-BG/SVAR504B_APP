...
fullfile('Plots','Producto EEUU.png'), ...
'AutoSave', true) 
...
for i = 1:length(toplot)
    ...
    SimTools.scripts.pausaGuarda(...
    fullfile('Plots', sprintf("%s.png",MODEL.PreProc.monthly.(toplot{i}).Comment{1})), ...
    'AutoSave', true) 
end
...
% tasa de intertrimestral anualizada
    ...
    SimTools.scripts.pausaGuarda(...
    fullfile('Plots', sprintf("%s.png",MODEL.PreProc.quarterly.imp_indx_qq.Comment{1})), ...
    'AutoSave', true) 
